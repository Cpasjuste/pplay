...
#define FFMPEG_CONFIGURATION "--prefix=/opt/devkitpro/portlibs/switch --cross-prefix=aarch64-none-elf- --target-os=linux --arch=aarch64 --disable-shared --enable-static --disable-encoders --disable-muxers --disable-network --disable-asm --disable-neon --disable-runtime-cpudetect"
