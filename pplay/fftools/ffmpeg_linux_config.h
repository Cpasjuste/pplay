...
#define FFMPEG_CONFIGURATION "--prefix=/usr --disable-shared --enable-static --target-os=linux --enable-pic --enable-libass --enable-libfreetype --enable-libfribidi --enable-libtheora --disable-protocols --enable-protocol='file,http' --disable-filters --enable-filter='rotate,transpose' --disable-encoders --disable-muxers --disable-programs --disable-debug --disable-doc --enable-encoder=png"
