...
#define FFMPEG_CONFIGURATION "--prefix=/opt/devkitpro/portlibs/switch --enable-cross-compile --cross-prefix=aarch64-none-elf- --arch=aarch64 --pkg-config=/opt/devkitpro/portlibs/switch/bin/aarch64-none-elf-pkg-config --disable-shared --enable-static --target-os=linux --enable-pic --enable-libass --enable-libfreetype --enable-libfribidi --enable-libtheora --disable-protocols --enable-protocol='file,http' --disable-filters --enable-filter='rotate,transpose' --disable-encoders --disable-muxers --disable-programs --disable-debug --disable-doc"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/opt/devkitpro/portlibs/switch/share/ffmpeg"
#define AVCONV_DATADIR "/opt/devkitpro/portlibs/switch/share/ffmpeg"
#define CC_IDENT "gcc 8.2.0 (devkitA64 release 12)"
